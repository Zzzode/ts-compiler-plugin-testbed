...
class CustomCompilerHost implements ts.CompilerHost {
  ...
  getSourceFile(
    ...
    let sourceFile = this.delegate.getSourceFile(fileName, languageVersion, onError, shouldCreateNewSourceFile);
    ...
    if (fileName.endsWith('.ts')) {
      ...
      if (fileContent) {
        ...
        sourceFile = this.createSourceFile(fileName, fileContent, languageVersion);
      }
    }
